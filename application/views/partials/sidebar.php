    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html">
                        <img src="<?= base_url(); ?>assets/img/header_sdi.png" alt="Logo" style="width: 160px; height: auto;">
                    </a>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <?php if ($this->session->userdata('role') == '2') { ?>
                    <li
                        class="sidebar-item <?= $this->uri->segment(1) == 'Dashboard' ? 'active' : '' ?> ">
                    ...
                    <li
                        class="sidebar-item <?= $this->uri->segment(1) == 'FormSiswa' ? 'active' : '' ?>">
                        <a href="<?= base_url('FormSiswa') ?>" class='sidebar-link'>
                ...
                if ($this->session->userdata('role') == '1') { ?>
                    ...
                    <li class="sidebar-title">Setting API</li>
                    <li
                        class="sidebar-item <?= $this->uri->segment(1) == 'Api' ? 'active' : '' ?>">
                        <a href=" <?php echo base_url('Api') ?>" class='sidebar-link'>
